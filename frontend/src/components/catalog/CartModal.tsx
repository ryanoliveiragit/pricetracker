          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-neutral-800/60 px-5 py-4">
              <div className="flex items-center gap-2.5">
                <ShoppingCart className="h-5 w-5 text-[rgb(var(--primary-500))]" />
                <h2 className="text-base font-semibold text-slate-800 dark:text-neutral-100">Carrinho</h2>
                {items.length > 0 && (
                  <span className="rounded-full bg-[rgb(var(--primary-500))/0.12] dark:bg-[rgb(var(--primary-600))/0.30] px-2 py-0.5 text-xs font-semibold text-[rgb(var(--primary-600))] dark:text-[rgb(var(--primary-500))/0.35]">
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4">
              {items.length === 0 ? (
                <div className="flex flex-col items-center justify-center gap-3 py-16 text-center">
                  ...
                  <button
                    onClick={onClose}
                    className="mt-1 text-xs text-[rgb(var(--primary-500))] underline-offset-4 hover:underline"
                  >
                    Continuar buscando
                  </button>
                </div>
                        ...
                        <div className="min-w-0 flex-1 space-y-1.5">
                          ...
                          <p className="flex items-center gap-1 text-xs text-slate-500 dark:text-neutral-500">
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="ml-auto text-[rgb(var(--primary-500))] hover:text-[rgb(var(--primary-600))] dark:hover:text-[rgb(var(--primary-500))]"
                            >
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              <span className="text-sm font-semibold text-[rgb(var(--primary-600))] dark:text-[rgb(var(--primary-500))/0.35]">
            ...
            {items.length > 0 && (
              <div className="space-y-3 border-t border-slate-200 dark:border-neutral-800/60 px-5 py-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className={cn(
                      ...
                      copied
                        ? "border-[rgb(var(--primary-500))]/40 bg-[rgb(var(--primary-500))/0.10] text-[rgb(var(--primary-500))]"
                ...
                <button
                  ...
                  className="w-full rounded-xl bg-[rgb(var(--primary-500))] px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-[rgb(var(--primary-500))/0.20] transition hover:bg-[rgb(var(--primary-600))] active:scale-[0.98]"
                >
                  Finalizar Pedido
                </button>
