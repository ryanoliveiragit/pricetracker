          ...
          >
            ...
            {hasPrev && (
              <button
                ...
                className="absolute -left-5 flex h-10 w-10 items-center justify-center rounded-full bg-neutral-800/90 text-neutral-200 shadow-lg backdrop-blur transition hover:bg-[rgb(var(--primary-600))] hover:text-white"
              >
            ...
            {hasNext && (
              <button
                onClick={() => onNavigate(currentIndex + 1)}
                className="absolute -right-5 flex h-10 w-10 items-center justify-center rounded-full bg-neutral-800/90 text-neutral-200 shadow-lg backdrop-blur transition hover:bg-[rgb(var(--primary-600))] hover:text-white"
              >
